...
export class ComparatorFormComponent implements OnInit {
  ...
  @ViewChild('etape22', { static: true }) step22: ElementRef;
  @ViewChild('etape32', { static: true }) step32: ElementRef;
  @ViewChild('etape42', { static: true }) step42: ElementRef;
  ...
  @ViewChild('addressRetourInput', { static: true })
  addressRetourInput: ElementRef;
  retourTabEnabled =false;
  ...
  checkStep12() {
    ...
    if (
      ...
      this.arrivalTabEnabled = true;
      this.step22.nativeElement.click();
    }
  }
  ...
  checkStep22() {
    ...
    if (
      ...
      this.passengersTabEnabled = true;
      this.step32.nativeElement.click();
    }
  }
  checkStep23() {
    this.searchForm.patchValue({
    ...
    if (
      ...
      this.passengersTabEnabled = true;
      this.step42.nativeElement.click();
    }
  }
  ...
  beforeSearch(){
    ...
    localStorage.setItem('addressArrival', this.searchForm.value.addressArrival);
     localStorage.setItem('addressRetour', this.searchForm.value.addressRetour);
 ...
 /* async search1() {
    ...
    if (this.searchForm.valid) {
      ...
      const vtcComparatorRequest = new VTCComparatorRequest(
        ...
        new VTCLocation(
          (
            await this.geocodeAddress(this.searchForm.value.addressRetour )
          ).place_id,
          (await this.geocodeAddress(this.searchForm.value.addressRetour)).lat,
          (await this.geocodeAddress(this.searchForm.value.addressRetour)).lng,
          this.searchForm.value.addressRetour,
          this.searchForm.value.addressRetour,
          this.searchForm.value.addressRetour
        ),
        ...
        // tripType
        new TripTypeDetails(TripType.DEFAUL, 0, null, null, null, null),
  ...
  // selectedRetour
 /* public setSelectedRetour(address: any) {
    if (address.types[0] == 'airport') {
      this.selectedRetour = 1;
    } else {
      this.selectedRetour = 0;
    }
  }*/
