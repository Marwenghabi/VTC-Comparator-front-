...
@Component({
  selector: 'app-offres-commun',
  templateUrl: './offres-commun.component.html',
  styleUrls: ['./offres-commun.component.scss']
})
export class OffresCommunComponent implements OnInit {
